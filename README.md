...
📖 [完整的5分钟快速开始指南](./docs/quick-start/快速开始_5分钟版.md)
...
📖 [完整的5分钟快速开始](./docs/quick-start/快速开始_5分钟版.md)
...
📖 [完整命令速查表](./docs/guides/COMMANDS.md)
...
### 新手必读 ⭐
- [5分钟快速开始](./docs/quick-start/快速开始_5分钟版.md) - 最快上手
- [命令速查表](./docs/guides/COMMANDS.md) - 所有命令说明
...
### 版本说明
- [v1.2.0 更新说明](./docs/releases/v1.2.0_更新说明.md) - 命令优化
- [改进总结](./docs/releases/v1.2.0_改进总结.md) - v1.2.0 改进分析
- [优化结果报告](./docs/releases/v1.2.1_优化报告.md) - Token 优化详情
